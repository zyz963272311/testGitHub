...
public class LoadWebServiceImpl implements ServletContextListener
{
	...
	public void contextInitialized(ServletContextEvent arg0)
	{
		...
		if (webServiceList != null && StrUtil.isNoStrTrimNull(webserviceHost))
		{
			for (Map<String,Object> webServiceMap : webServiceList)
			{
				...
				//				String serviceinterface = StrUtil.obj2str(webServiceMap.get("serviceinterface"));
				...
				try
				{
					...
					System.out.println(servicename + "发布成功,实现类是" + serviceimpl);
	...
	public static void main(String[] args)
	{
		...
		try
		{
			URL url = new URL(BasConfig.getPropertie("webservice-host"));
			QName name = new QName("spring.HelloWebService");
