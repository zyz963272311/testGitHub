...
function mouseover(obj) {
	...
	if (li_type == 'wechat') {
		...
		document.getElementById("showimghref").href = "http://wpa.qq.com/msgrd?v=3&uin=309332998&site=qq&menu=yes"loadtext(0)
	} else if (li_type == 'weblog') {
		loadweblogtext(0)
	} else if (li_type = 'phone') {
		document.getElementById("wb").style.display = 'none';
		document.getElementById("talk").innerTEXT = "崔先生:15011052173";
		document.getElementById("showimghref").href = "tel:15011052173"loadtext(0)
	}
}
function mouseout(i) {
	if (i == 0) {
...
function todisplay() {
	document.getElementById("showimgdiv").style.opacity = 1.0;
	document.getElementById("showimgdiv").style.filter = "alpha(opacity=100)"document.getElementById("showimgdiv").style.display = 'none';
	document.getElementById("wb").style.display = 'none'
}
