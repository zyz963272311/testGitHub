 ...
 * <p>公司: 赵玉柱练习</p>
 * <p>创建日期：2018年9月20日 下午8:49:13</p>
 * <p>类全名：xyz.zyzhu.spring.boot.jdalli.model.QueryExplosiveGoods_Result</p>
 * 作者：赵玉柱
 * 初审：
 * 复审：
 * 监听使用界面:
 * @version 8.0
 */
public class QueryExplosiveGoodsResult extends BasObject
{
	private static final long	serialVersionUID	= 621148856198723659L;
	private String				skuId;										//商品id
	private String				skuName;									//商品名称
	private String				skuUrl;										//商品地址
	private String				shopName;									//店铺名称
	private String				shopUrl;									//店铺地址
	private String				imgUrl;										//图片地址
	private BigDecimal			pcPrice;									//价格
	...
	private BigDecimal			inOrderComm;								//排序标示30天引入佣金金额
	private BigDecimal			inOrderCount;								//排序标示30天引入量
	private String				plan;										//计划
	private String				isPlan;										//定向计划
	private String				prmTab;										//促销标签
	private BigDecimal			realRate;									//商品几折
	private String				adowner;									//广告主
	private String				vid;										//商家
	private BigDecimal			total;										//商品数量
	private String				resultCode;									//接口是否调用成功 （200：接口返回成功）
	...
	public BigDecimal getInOrderComm()
	{
		return inOrderComm;
	}

	public void setInOrderComm(BigDecimal inOrderComm)
	{
		//setValue("inOrderComm", inOrderComm);
		this.inOrderComm = inOrderComm;
	}

	public BigDecimal getInOrderCount()
	{
		return inOrderCount;
	}

	public void setInOrderCount(BigDecimal inOrderCount)
	{
